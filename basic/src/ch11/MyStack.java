...
/*
	Stack은 컬렉션 프레임웍 이전부터 존재하던 것이기 때문에 Vector로 부터 상속받아 구현
	Stack Method
		empty()
		peek() : 맨 위 저장된 객체 반환, pop()과 달리 객체를 꺼내지는 않음
		pop() : 맨 위 저장딘 객체 꺼냄
		push() : 객체 저장
		search() : 객체를 찾아서 그 위치 반환
*/
class MyStack extends Vector {
    ...
    public int search(Object o) {
		int i = lastIndexOf(o);	// 끝에서부터 객체를 찾는다. Vector method
